                ...
                <div class="col-sm-6">
                    <form action="register" method="POST">
                        ...
                        <div class="form-group">    
                            ...
                            <input type="text" name="name" class="form-control" id="exampleInputUser" placeholder="User Name">
                            </div>
                        <div class="form-group">    
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-12 col-lg-7">
                <div class="welcome-intro">
                    ...
                    <p class=" my-4">Give Username, Email & Password to Register.</p>
                </div>
            </div>
                ...
                <div class="contact-box bg-white text-center rounded p-4 p-sm-5 mt-5 mt-lg-0 shadow-lg">
                    ...
                    @csrf
                        ...
                        <div class="contact-top">
                            <h3 class="contact-title mb-5">Create Account</h3>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><svg class="svg-inline--fa fa-user-alt fa-w-16" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                                ...
                                                </svg><!-- <i class="fas fa-user-alt"></i> --></span>
                                        </div>
                            ...
                            <div class="col-12">
                                <button class="btn btn-bordered w-100 mt-3 mt-sm-4" type="submit">Register</button>
                            </div>
                        </div>
                    </form>
