            ...
            <div class="row">
                ...
                <div class="row">
                  <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="footer-items footer-custom">
                      <!-- <h3
                        class="footer-title mb-2 text-center"
                        data-translatekey="developed-by"
                      >
                        Developed By
                      </h3> -->
                      <a
                          class="navbar-brand footer-logo-custom"
                          href="#"
                        >
                          <img class="" src="assets/img/jadoo/Jadoo.png" alt="" />
                        </a>
                      <div
                        class="
                          button-group
                  ...
                  <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="footer-items text-center">
                      <!-- Footer Title -->
                      <h3 class="footer-title mb-2" data-translatekey="location">
                        Company
                      </h3>
                      <div
                        class="
                  ...
                  <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="footer-items text-center">
                      <!-- Footer Title -->
                      <h3 class="footer-title mb-2" data-translatekey="contact">
                        Contact
                      </h3>
                      <div
                        class="
                      ...
                      <!-- <div class="social-icons d-flex justify-content-center">
                        <a
                          class="facebook"
                          href="https://www.facebook.com/medinatech.co"
                        >
                  ...
                  <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="footer-items text-center">
                      <!-- Footer Title -->
                      <h3
                        class="footer-title mb-2"
                        data-translatekey="useful-links"
                      >
                       More
                      </h3>
                      <!-- Store Buttons -->
              ...
              <div class="col-lg-3">
                ...
                <div class="footer-items text-center">
                  ...
                  >
                    <ul>
                      <li class="py-2 share"> <i class="other fab fa-facebook-f"></i>
                        <i class="insta fab fa-instagram"></i> <i class="other fab fa-twitter"></i>
                      </li>
                      <li class="py-2">
                        <a
                          href="#about"
                      ...
                      <li class="py-2">
                        <button class="appBtn">
                          <svg class="btn__logo" version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="708.662px" height="708.662px" viewBox="0 0 708.662 708.662" enable-background="new 0 0 708.662 708.662" xml:space="preserve">
                            <path id="c" fill="#FFFFFF" d="M607.229,229.405L607.229,229.405c-26.838,0-48.596,21.756-48.596,48.594v172.106
                              ...
                              C655.823,251.159,634.067,229.405,607.229,229.405z"></path>
                            <path fill="#FFFFFF" d="M538.536,220.405c0-62.651-36.705-117.381-91.341-146.892l27.939-50.406
                              ...
                              s10.932,4.896,10.932,10.935C445.253,143.427,440.361,148.322,434.322,148.322z"></path>
                            <path fill="#FFFFFF" d="M170.241,240.093v269.753c0,24.602,19.943,44.545,44.545,44.545h17.06v92.115
                              ...
                              s48.594-21.756,48.594-48.594v-92.115h27.486c24.602,0,44.545-19.943,44.545-44.545V240.093H170.241z"></path>
                            <path id="c_2_" fill="#FFFFFF" d="M101.435,229.405L101.435,229.405c-26.838,0-48.596,21.756-48.596,48.594v172.106
                              ...
                              C150.028,251.159,128.272,229.405,101.435,229.405z"></path>
                            </svg>
                            ...
                            <g>
                              <g id="g25472" transform="translate(19.48863,19.49672)">
                                <path id="path190" fill="#FFFFFF" d="M438.59,109.303c23.751-28.768,39.785-68.768,35.368-108.638
                                  ...
                                  C375.867,160.409,414.836,138.027,438.59,109.303"></path>
                              </g>
                              <g id="g186" transform="matrix(54.85033,0,0,-54.85033,-1411.313,6454.729)">
                                <path id="path188" fill="#FFFFFF" d="M35.575,110.939c-0.014,1.57,1.282,2.323,1.34,2.36c-0.729,1.067-1.864,1.213-2.269,1.23
                                  ...
                                  C37.221,108.438,35.592,109.063,35.575,110.939"></path>
                              </g>
                            </g>
                            </svg>
